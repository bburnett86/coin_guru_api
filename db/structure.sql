...
CREATE INDEX index_coins_on_name ON public.coins USING gin (name public.gin_trgm_ops);
...
CREATE INDEX index_coins_on_symbol ON public.coins USING gin (symbol public.gin_trgm_ops);
...
CREATE INDEX index_users_on_username ON public.users USING gin (username public.gin_trgm_ops);
